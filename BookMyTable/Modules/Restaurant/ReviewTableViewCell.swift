...
//  BookMyTable
//
//  Created by Evelina on 26.05.2023.
//
...
//    private lazy var starFilledImage: UIImageView = {
...
//    }()
    ...
    private func initialize() {
        ...
        [authorLabel, xStack, commentLabel].forEach({yStack.addArrangedSubview($0)})
        [ratingLabel, dateLabel].forEach({xStack.addArrangedSubview($0)})
